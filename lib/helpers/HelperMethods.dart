...
class HelperMethods {
  ...
  String url = "https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude},${position.longitude}&key=AIzaSyA18MNzjk_fM6KMyRnx4JAeloi1skVdkts";
  ...
  static Future<DirectionDetails> getDirectionDetails(LatLng startPosition, LatLng endPosition) async {
    ...
    String url = "https://maps.googleapis.com/maps/api/directions/json?origin=${startPosition.latitude},${startPosition.longitude}&destination=${endPosition.latitude},${endPosition.longitude}&mode=driving&key=AIzaSyA18MNzjk_fM6KMyRnx4JAeloi1skVdkts";
    var response = await RequestHelper.getRequest(url);
    if(response == 'failed'){
      return null ;
    }
