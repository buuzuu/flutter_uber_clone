...
import 'package:uber_clone/widgets/predictionTile.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  void setFocus() {
    if (!focused) FocusScope.of(context).requestFocus(focusDestination);
  ...
  void searchPlace(String placeName) async {
    if (placeName.length > 1) {
      String url =
          'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=AIzaSyA18MNzjk_fM6KMyRnx4JAeloi1skVdkts&sessiontoken=1234567890&components=country:ie';
        ...
        children: [
          Container(
            ...
            child: Padding(
              padding: const EdgeInsets.only(
                  top: 48, right: 24, left: 24, bottom: 20),
              child: Column(
                children: [
                  SizedBox(
                    height: 5,
          ...
          Padding(
            ...
            child: ListView.separated(
              ...
              return PredictionTile(destinationPredictionList[index]);
            },
